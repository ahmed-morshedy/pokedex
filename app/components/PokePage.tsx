  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="Pokeball"
        className="absolute top-7 right-1   md:right-7 md:block  z-10   "
      />

      <div className=" absolute p-3 top-0 z-20 -translate-x-1/2 left-1/2 w-full ">
        {/* Title */}
        ...
        <div className="flex justify-center items-center">
          ...
          <Link href={`/pokemon/${idPram + 1}`}>
            <img
              ...
              alt=" next pokemon "
              className={clsx(" stroke-3 hover:translate-x-2 transition-all ", {
                hidden: id > 999,
              })}
            />
          </Link>
